<x-app-layout>
    <x-slot name="meta">
        <x-seo-meta title="Login Petugas - Setia Buah" />
    </x-slot>

    <div class="max-w-md mx-auto mt-16 px-4">
        <div class="bg-white p-8 border border-gray-200 rounded-lg shadow-sm">
            <h2 class="text-2xl font-bold text-center text-green-700 mb-8">Login Admin & Petani</h2>
            ...
            <div class="mt-6 text-center text-sm text-gray-500">
                <p>Akses ini khusus untuk petugas intern (Admin & Petani).</p>
                <p>Pembeli <a href="{{ route('shop.index') }}" class="text-green-600 font-bold hover:underline">tidak perlu login</a>.</p>
            </div>
        </div>
    </div>
</x-app-layout>