<x-app-layout>
    <x-slot name="meta">
        <x-seo-meta title="Login Pembeli - Setia Buah" />
    </x-slot>

    <div class="max-w-md mx-auto mt-16 px-4">
        <div class="bg-white p-8 border border-gray-200 rounded-lg shadow-sm">
            <h2 class="text-2xl font-bold text-center text-green-700 mb-8">Login Pembeli</h2>
            ...
            <form method="POST" action="{{ route('buyer.login.post') }}" class="space-y-6">
                @csrf
                <div>
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                Belum punya akun? <a href="{{ route('buyer.register') }}" class="text-green-600 font-bold hover:underline">Daftar sekarang</a>
            </div>
        </div>
    </div>
</x-app-layout>